...
part 'KnowledgeItemBean.g.dart';

@JsonSerializable()
class KnowledgeItemBean {
  DataBean data;
  num errorCode;
  String errorMsg;

  KnowledgeItemBean({required this.data,required this.errorCode,required this.errorMsg});

  factory KnowledgeItemBean.fromJson(Map<String, dynamic> json) => _$KnowledgeItemBeanFromJson(json);

  Map<String, dynamic> toJson() => _$KnowledgeItemBeanToJson(this);
}
